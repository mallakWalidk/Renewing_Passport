...
namespace RenewingPassport.Infra.Repository
{
    public class AboutUsRepository : IAboutUsRepository
    {
        ...
        {
            IEnumerable<AboutUsPage> result = dbContext.Connection.Query<AboutUsPage>("aboutuspagepage_package.GetAllAboutUsPage", commandType: CommandType.StoredProcedure);
